...
urlpatterns = [
    ...
    path('reservas/facturar/modal/<int:reserva_id>/', views.modal_facturar_reserva, name='modal_facturar_reserva'),
    path('reservas/facturar/procesar/<int:reserva_id>/', views.procesar_factura_reserva, name='procesar_factura_reserva'),
